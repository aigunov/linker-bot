...
public class RedisCacheIntegrationTest {
    ...
    void shouldStoreDigestRecord() {
        ...
        redisService.storeUpdate(Set.of(mockChat(1001L)), mockLink(record.url(), record.linkId()), mockUpdate(record.message()));
    ...
    void shouldConsumerRecordsGroupeByChatId() {
        DigestRecord rec1 = DigestRecord
            .builder()
            .chatId(1L)
            .url("url1")
            .message("msg1")
            .linkId(UUID.randomUUID()).build();
        DigestRecord rec2 = DigestRecord
            .builder()
            .chatId(1L)
            .url("url2")
            .message("msg2")
            .linkId(UUID.randomUUID()).build();
        DigestRecord rec3 = DigestRecord
            .builder()
            .chatId(2L)
            .url("url3")
            .message("msg3")
